...
![A978-1-4842-1070-3_6_Fig1_HTML.jpg](A978-1-4842-1070-3_6_Fig1_HTML.jpg)
...
![A978-1-4842-1070-3_6_Fig2_HTML.jpg](A978-1-4842-1070-3_6_Fig2_HTML.jpg)
...
表 [6-1](#Tab1) 提供了 Solr 提供的主要部件的关键信息。在表中,“名称”列表示组件的默认名称，您可以更改它。默认栏列出了在`SearchHandler`中默认配置的组件。要使用非默认的组件，您需要将它注册到现有的处理程序，或者配置一个新的处理程序并将其注册到该处理程序。
...
javabin 响应返回一个 Java 对象，Java 客户机可以使用这个对象。对于使用 SolrJ 客户机的请求，这是首选的响应格式。类似地，Python、PHP 和 Ruby 格式也可以被这些语言的客户端直接使用。Velocity 是另一种受支持的有趣的响应格式，它允许您使用 Apache Velocity 模板引擎将响应转换成网页。
...
![A978-1-4842-1070-3_6_Fig3_HTML.jpg](A978-1-4842-1070-3_6_Fig3_HTML.jpg)
...
![A978-1-4842-1070-3_6_Fig4_HTML.jpg](A978-1-4842-1070-3_6_Fig4_HTML.jpg)
