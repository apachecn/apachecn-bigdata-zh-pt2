...
![](assets/0736a2bc-163a-4774-b4c1-347e8e2afea7.png)
...
需要理解的一件重要的事情是，我们正在这个集群中运行应用程序的所有其他实例。由于每个应用程序都在自己的预定义位置维护其状态，因此应用程序状态不会从主 Hadoop 集群复制到该集群，这意味着在主 Hadoop 集群中创建的作业在该集群中不可见。这同样适用于卡夫卡的主题，动物园管理员节点，以及更多。
