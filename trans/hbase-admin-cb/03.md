...
![How it works...](graphics/7140_03_01.jpg)
...
![How it works...](graphics/7140_03_02.jpg)
...
![How it works...](graphics/7140_03_03.jpg)
...
![Getting ready](graphics/7140_03_04.jpg)
...
2.  You can also flush an individual region by passing the region name to the `flush` command:
    ...
    *   您可以在表的管理页面的**表区域**部分下找到该区域的名称：
    ...
    ![How to do it...](graphics/7140_03_05.jpg)
...
5.  Split a region in a table by running the `split` command:
    ...
    *   在表的管理页面中，您会发现该区域已被分成两个区域，因此总区域计数变为 4：
    ...
    ![How to do it...](graphics/7140_03_06.jpg)
...
![How it works...](graphics/7140_03_07.jpg)

在执行平衡操作之后，我们的集群变得更加均衡，因为区域被分配到集群中的所有区域服务器：

![How it works...](graphics/7140_03_08.jpg)
...
2.  Execute the `rowcounter` command from your client:
    ...
    *   您将获得以下输出：
    ...
    ![How to do it...](graphics/7140_03_09.jpg)
...
![How it works...](graphics/7140_03_10.jpg)
...
![How to do it...](graphics/7140_03_11.jpg)
...
1.  Check the health of the cluster with the default `hbck` command option:
    ...
    *   您将获得以下输出：
    ...
    ![How to do it...](graphics/7140_03_12.jpg)
...
17.  Confirm the data in HBase, which we inserted via HQL in the previous step:
    ...
    *   您将获得以下输出：
    ...
    ![How to do it...](graphics/7140_03_13.jpg)
...
![How it works...](graphics/7140_03_14.jpg)
