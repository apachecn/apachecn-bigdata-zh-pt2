...
Simple文本搜索系统依靠倒排索引来查找包含给定词或术语的文档集。 在本食谱中，我们实现了一个简单的倒排索引构建应用，该应用计算文档中的术语列表、包含每个术语的文档集以及每个文档中的术语频率。 从倒排索引检索结果可以像返回包含给定项的文档集一样简单，也可以涉及复杂得多的操作，例如返回基于特定排名排序的文档集。
