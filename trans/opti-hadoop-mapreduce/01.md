...
![The MapReduce model](graphics/5655OS_01_01.jpg)
...
要启动MapReduce 作业，Hadoop 需要创建 MapReduce 应用程序的一个实例，并将该作业提交给 JobTracker。 然后，作业被划分为映射任务(也称为映射器)和 Reduce 任务(也称为 Reducer)。
