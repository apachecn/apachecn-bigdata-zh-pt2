...
![A456459_1_En_5_Fig1_HTML.jpg](A456459_1_En_5_Fig1_HTML.jpg)
...
![A456459_1_En_5_Fig2_HTML.jpg](A456459_1_En_5_Fig2_HTML.jpg)
...
你将在整章中使用火花壳。当您启动如清单 [5-1](#Par14) 所示的 spark2-shell 时，会自动创建一个名为“spark”的 SparkSession。
...
启动火花壳。请注意，我必须将 MySQL 驱动程序作为参数包含在–driver-class-path 和–jar 中。在较新版本的 Spark 中，您可能不需要这样做。
...
将数据框注册为临时表，以便我们可以对其运行 SQL 查询。在 Spark 2.x 中，使用 createOrReplaceTempView。
...
机器学习是 Spark 的主要应用之一。基于数据框架的 API (Spark ML 或 Spark ML 管道)现在是 Spark 的主要 API。基于 RDD 的 API (Spark MLlib)正在进入维护模式。我们不会讨论旧的基于 RDD 的 API。以前，基于数据帧的 API 被非正式地称为 Spark ML 和 Spark ML 管道(spark.ml 包),以区别于基于 RDD 的 API，后者是基于原始 spark.mllib 包命名的。一旦基于数据帧的 API 达到特性对等，基于 RDD 的 API 在 Spark 2.3 中将被弃用。 [<sup>xiii</sup>](#Sec66) 基于 RDD 的 API 将在 Spark 3.0 中被移除。目前，Spark MLlib 包含这两种 API。
...
![A456459_1_En_5_Fig3_HTML.jpg](A456459_1_En_5_Fig3_HTML.jpg)
...
我在第 6 章中介绍了火花流。Spark 2.0 包括一个新的流处理框架，称为结构化流，这是一个构建在 Spark SQL 之上的高级流 API。撰写本文时，Cloudera 还不支持结构化流。[T3】XVIIT5】](#Sec66)
...
![A456459_1_En_5_Fig5_HTML.jpg](A456459_1_En_5_Fig5_HTML.jpg)

图 5-5

Monitoring Spark Jobs

![A456459_1_En_5_Fig4_HTML.jpg](A456459_1_En_5_Fig4_HTML.jpg)
...
Spark 历史服务器提供关于已经完成执行的 Spark 应用程序的详细信息。Spark 历史服务器可以通过端口 18088 访问(图 [5-6](#Fig6) )。可以查看详细的性能指标(图 [5-7](#Fig7) 和图 [5-8](#Fig8) )和关于火花环境的信息(图 [5-9](#Fig9) )以帮助监控和故障排除。

![A456459_1_En_5_Fig9_HTML.jpg](A456459_1_En_5_Fig9_HTML.jpg)

图 5-9

Information about the current Spark environment

![A456459_1_En_5_Fig8_HTML.jpg](A456459_1_En_5_Fig8_HTML.jpg)

图 5-8

Performance metrics on Spark executors

![A456459_1_En_5_Fig7_HTML.jpg](A456459_1_En_5_Fig7_HTML.jpg)

图 5-7

Detailed performance information about a particular Spark job

![A456459_1_En_5_Fig6_HTML.jpg](A456459_1_En_5_Fig6_HTML.jpg)
...
5.  数据块；“什么是阿帕奇火花？，“Databricks，2018， [`https://databricks.com/spark/about`](https://databricks.com/spark/about)
...
7.  霍尔登·卡劳，雷切尔·沃伦；“高性能火花”，奥莱利，2017 年 6 月， [`https://www.safaribooksonline.com/library/view/high-performance-spark/9781491943199/`](https://www.safaribooksonline.com/library/view/high-performance-spark/9781491943199/)
