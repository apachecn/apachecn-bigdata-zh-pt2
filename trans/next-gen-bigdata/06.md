...
插入数据框。记下表的名称。如果表是在 Impala 中创建的，就需要这种格式。在本例中，default 是数据库的名称，customers 是表的名称。采用这种约定是为了防止在 Impala 中创建的表和使用 Kudu API 或 Spark 本地创建的表之间的表名冲突。
...
现在让我们回到 impala-shell，将模式与 users 表的结构进行比较。如您所见，用户表中年龄和邮政编码列的数据类型不同于数据框中的相应列。如果我们试图将这个数据帧插入到 Kudu 表中，我们会得到一个错误消息。
...
启动火花壳。请注意，我必须将 MySQL 驱动程序作为参数包含在–driver-class-path 和–jar 中。
...
![A456459_1_En_6_Fig1_HTML.jpg](A456459_1_En_6_Fig1_HTML.jpg)
...
![A456459_1_En_6_Fig2_HTML.jpg](A456459_1_En_6_Fig2_HTML.jpg)
...
![A456459_1_En_6_Fig3_HTML.jpg](A456459_1_En_6_Fig3_HTML.jpg)
...
![A456459_1_En_6_Fig4_HTML.jpg](A456459_1_En_6_Fig4_HTML.jpg)
...
![A456459_1_En_6_Fig5_HTML.jpg](A456459_1_En_6_Fig5_HTML.jpg)
...
启动火花壳。不要忘记在-driver-class-path 和-jar 中将 SQL Server 驱动程序作为参数传递。
...
![A456459_1_En_6_Fig6_HTML.jpg](A456459_1_En_6_Fig6_HTML.jpg)
...
![A456459_1_En_6_Fig7_HTML.jpg](A456459_1_En_6_Fig7_HTML.jpg)
...
![A456459_1_En_6_Fig8_HTML.jpg](A456459_1_En_6_Fig8_HTML.jpg)
...
启动火花壳。不要忘记包括 oracle 驱动程序。在这个例子中，我使用的是 ojdbc6.jar。
...
![A456459_1_En_6_Fig9_HTML.jpg](A456459_1_En_6_Fig9_HTML.jpg)
...
![A456459_1_En_6_Fig10_HTML.jpg](A456459_1_En_6_Fig10_HTML.jpg)
...
启动 spark-shell 并从 kudu 表创建一个数据框。
...
将数据框附加到镶木地板桌子上。您也可以使用关键词“覆盖”而不是“追加”来覆盖目的位置
...
![A456459_1_En_6_Fig11_HTML.jpg](A456459_1_En_6_Fig11_HTML.jpg)
...
![A456459_1_En_6_Fig12_HTML.jpg](A456459_1_En_6_Fig12_HTML.jpg)
...
2.  霍尔登·卡劳，雷切尔·沃伦；“高性能火花”，奥莱利，2017 年 6 月 [`https://www.safaribooksonline.com/library/view/high-performance-spark/9781491943199/`](https://www.safaribooksonline.com/library/view/high-performance-spark/9781491943199/)
...
4.  张占；《HBASE 星火:基于数据框架的 HBASE 连接器》，霍顿作品，2016， [`https://hortonworks.com/blog/spark-hbase-dataframe-based-hbase-connector/`](https://hortonworks.com/blog/spark-hbase-dataframe-based-hbase-connector/)
