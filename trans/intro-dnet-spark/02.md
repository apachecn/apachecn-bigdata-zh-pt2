...
来配置。NET for Apache Spark，所以 UDF 工作，你首先需要访问项目的 releases 页面( [`https://github.com/dotnet/spark/releases`](https://github.com/dotnet/spark/releases) )，选择你要使用的版本和操作系统，下载并解压到某个地方，然后创建`DOTNET_WORKER_DIR`环境变量指向与微软的目录。火花。工人可执行文件。
